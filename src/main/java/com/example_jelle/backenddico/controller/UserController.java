...
public class UserController {
    ...
    // --- NIEUW ENDPOINT ---
    // Dit endpoint is beveiligd en kan alleen door een ingelogde gebruiker worden aangeroepen.
    @PostMapping("/onboarding")
    public ResponseEntity<Void> saveOnboardingData(@Valid @RequestBody OnboardingRequestDto onboardingData, Authentication auth) {
        String userEmail = auth.getName();
        userService.saveOnboardingData(userEmail, onboardingData);
